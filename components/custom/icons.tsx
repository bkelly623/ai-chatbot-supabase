...
export const UndoIcon = ({ className, ...props }: IconProps) => {
  return (
    ...
    >
      ...
      <path d="M4 9h10.5a5.5 5.5 0 0 1 0 11H6" />
    </svg>
  );
};

export const RedoIcon = ({ className, ...props }: IconProps) => {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 24 24"
    ...
    >
      ...
      <path d="M20 9H9.5a5.5 5.5 0 0 0 0 11H18" />
    </svg>
  );
};

export const DeltaIcon = ({ className, ...props }: IconProps) => {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 24 24"
...
export const PencilEditIcon = ({ className, ...props }: IconProps) => {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 24 24"
...
export const SidebarLeftIcon = ({ className, ...props }: IconProps) => {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 24 24"
...
export const SummarizeIcon = ({ className, ...props }: IconProps) => {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 24 24"
